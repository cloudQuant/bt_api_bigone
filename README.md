...
This package provides **BigONE exchange plugin for bt_api** for the [bt_api](https://github.com/cloudQuant/bt_api_py) framework. It offers a unified interface for interacting with **BIGONE** exchange.
...
```python
from bt_api_bigone import BigoneApi

# Initialize
feed = BigoneApi(api_key="your_key", secret="your_secret")
...
| GitHub Repository | https://github.com/cloudQuant/bt_api_bigone |
| Issue Tracker | https://github.com/cloudQuant/bt_api_bigone/issues |
...
- Report bugs via [GitHub Issues](https://github.com/cloudQuant/bt_api_bigone/issues)
...
本包为 [bt_api](https://github.com/cloudQuant/bt_api_py) 框架提供 **BigONE exchange plugin for bt_api**。它提供了与 **BIGONE** 交易所交互的统一接口。
...
| GitHub 仓库 | https://github.com/cloudQuant/bt_api_bigone |
...
- 通过 [GitHub Issues](https://github.com/cloudQuant/bt_api_bigone/issues) 反馈问题
